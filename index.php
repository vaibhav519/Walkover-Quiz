...
<body>
  <div class="header">
    <div class="row">
      <div class="col-lg-6">
        <span class="logo">Walkover Quiz</span>
      </div>
        ...
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-12 control-label" for="name"></label>
              <div class="col-md-12">
                <div id="errormsg" style="font-size:14px;font-family:calibri;font-weight:normal;color:red;font-weight:bold"><?php
                                                                                                            if (@$_GET['q7']) {
            ...
            <div class="form-group">
              <label class="col-md-12 control-label" for="name"></label>
              <div class="col-md-12">
                <input id="name" name="name" placeholder="Enter your name" style="font-weight:bolder" class="form-control input-md" type="text" value="<?php
                                                                                                                            echo $_GET['name'];
                                                                                                                            ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="rollno" name="rollno" placeholder="Enter your Roll no (Ex. BE/10XXX/YY)" style="font-weight:bolder" class="form-control input-md" type="text" value="<?php
                                                                                                                                                      echo $_GET['rollno'];
                                                                                                                                                      ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="username" name="username" style="font-weight:bolder" placeholder="Choose a username" class="form-control input-md" type="username" value="<?php
                                                                                                                                          echo $_GET['username'];
                                                                                                                                          ?>" style="<?php
            if (isset($_GET['q7']))
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="phno" name="phno" style="font-weight:bolder" placeholder="Enter your mobile number" class="form-control input-md" type="number" value="<?php
                                                                                                                                        echo $_GET['phno'];
                                                                                                                                        ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="password" style="font-weight:bolder" name="password" placeholder="Enter your password" class="form-control input-md" type="password">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="cpassword" style="font-weight:bolder" name="cpassword" placeholder="Confirm Password" class="form-control input-md" type="password">
  ...
  <div class="row footer">
    <div class="col-md-6 box">
      <a href="#" data-toggle="modal" data-target="#login" style="color:lightyellow;font-weight:bolder;">Admin Login</a><br><br>
    </div>
    <div class="col-md-6 box">
