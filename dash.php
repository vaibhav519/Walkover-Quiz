...
<title> Admin || Walkover Quiz</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Walkover Quiz</span></div>
<?php
...
if (@$_GET['q'] == 0)
    echo 'class="active"';
?>><a href="dash.php?q=0" style="font-weight:bolder;">Home<span class="sr-only">(current)</span></a></li>
        <li <?php
if (@$_GET['q'] == 1)
    echo 'class="active"';
?>><a href="dash.php?q=1"  style="font-weight:bolder;">Users</a></li>
    <li <?php
if (@$_GET['q'] == 2)
    echo 'class="active"';
?>><a href="dash.php?q=2"  style="font-weight:bolder;">Leaderboard</a></li>
    <li <?php
if (@$_GET['q'] == 3)
    echo 'class="active"';
?>><a href="dash.php?q=3"  style="font-weight:bolder;">Feedback</a></li>
        <li <?php
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4"  style="font-weight:bolder;">Add Quiz</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="dash.php?q=5"  style="font-weight:bolder;">Remove Quiz</a></li>
      </ul>
          </div>
  </div>
</nav>
